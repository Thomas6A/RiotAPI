document.addEventListener("DOMContentLoaded", async function () {
  ...
  async function detailChampion(id){
    ...
    fetch(`http://ddragon.leagueoflegends.com/cdn/13.10.1/data/fr_FR/champion/${id}.json`,"GET",function(){
        let result = JSON.parse(this.response)
        ...
        passifp.innerHTML += champion.passive.name+" : "+ champion.passive.description
